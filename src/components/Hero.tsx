...
const Hero = () => {
  ...
  const isFeature1Visible = useIntersectionObserver(featureRef1);
  const isFeature2Visible = useIntersectionObserver(featureRef2);
  const isFeature3Visible = useIntersectionObserver(featureRef3);
  ...
  return (
    <section className="relative pt-24 pb-16 md:py-32 px-6 md:px-12 lg:px-16 overflow-hidden">
      ...
      <div className="absolute top-20 left-1/2 w-[800px] h-[800px] -translate-x-1/2 rounded-full bg-nova-blue/5 blur-3xl -z-10"></div>
      
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="order-2 lg:order-1">
            <span className="inline-block px-3 py-1 bg-nova-blue/10 text-nova-blue rounded-full text-sm font-medium mb-4 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate-fade-in animate-delay-400">
              <a href="#features" className="button-highlight bg-nova-blue text-white px-8 py-4 rounded-full font-medium shadow-button text-center hover:bg-nova-darkBlue transition-colors">
                Conoce más
              </a>
              <a href="https://novagps.mx/plataforma" target="_blank" rel="noopener noreferrer" className="px-8 py-4 rounded-full border border-nova-blue/30 text-nova-blue font-medium hover:bg-nova-blue/5 transition-colors text-center">
                Ir a la plataforma
              </a>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 relative animate-fade-in">
            <div className="relative">
              ...
              >
                <div className="font-medium text-nova-blue mb-1">Localización en vivo</div>
              ...
              >
                <div className="font-medium text-nova-blue mb-1">Historial de rutas</div>
              ...
              >
                <div className="font-medium text-nova-blue mb-1">Ahorro de combustible</div>
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 animate-bounce-light hidden md:block">
        <a href="#features" aria-label="Scroll down">
          <ChevronDown className="text-nova-blue/60 h-8 w-8" />
        </a>
      </div>
    </section>
  );
